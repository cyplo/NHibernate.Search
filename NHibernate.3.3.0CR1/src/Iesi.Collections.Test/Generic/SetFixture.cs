...
namespace Iesi.Collections.Test.Generic
{
	...
	public abstract class GenericSetFixture
	{
        ...
        protected IESI.ISet<string> _set;
		...
		public void ExclusiveOr()
		{
            ...
            var aNull = IESI.Set<string>.ExclusiveOr(a, null);
            ...
            var bNull = IESI.Set<string>.ExclusiveOr(null, b);
            ...
            var bothNull = IESI.Set<string>.ExclusiveOr(null, null);
		...
		public void Minus()
		{
            ...
            var ab = IESI.Set<string>.Minus(a, b);
		...
		public void Union()
		{
            ...
            var ab = IESI.Set<string>.Union(a, b);
            ...
            var aNull = IESI.Set<string>.Union(a, null);
            ...
            var bNull = IESI.Set<string>.Union(null, b);
            ...
            var bothNull = IESI.Set<string>.Union(null, null);
		...
		public void ExclusiveOrOperator()
		{
            ...
            var ab = (IESI.Set<string>)a ^ (IESI.Set<string>)b;
        ...
        protected abstract IESI.ISet<string> CreateInstance();

		protected abstract IESI.ISet<string> CreateInstance(ICollection<string> init);
