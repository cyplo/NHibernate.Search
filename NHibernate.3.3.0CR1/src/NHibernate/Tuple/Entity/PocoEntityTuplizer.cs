...
namespace NHibernate.Tuple.Entity
{
	...
	public class PocoEntityTuplizer : AbstractEntityTuplizer
	{
		...
		private readonly IESI.HashedSet<string> lazyPropertyNames = new IESI.HashedSet<string>();
		private readonly IESI.HashedSet<string> unwrapProxyPropertyNames = new IESI.HashedSet<string>();
		[NonSerialized]
		...
		public override void AfterInitialize(object entity, bool lazyPropertiesAreUnfetched, ISessionImplementor session)
		{
			...
			{
				IESI.HashedSet<string> lazyProps = lazyPropertiesAreUnfetched && EntityMetamodel.HasLazyProperties ? lazyPropertyNames : null;
